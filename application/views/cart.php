  ...
  <div class="col-sm-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <table class="table table-striped" style="background-color: #191339; color: maroon;">
          <thead>
            <tr>
              <th>No</th>
              <th>Gambar</th>
...
?>
      ...
      <div class="panel-footer" style="background-color: #191339;">
        ...
        <a href="<?php echo base_url('sewa/invoice')?>" class="btn btn-info pull-right">Proceed to Checkout</a>
      </div>
    </div>
  </div>
</div>
