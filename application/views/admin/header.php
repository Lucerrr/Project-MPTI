...
<head>
  ...
  <style>
    ...
    /* Perubahan untuk skin-navy */
    .skin-navy .main-header .navbar {
      background-color: #191339;
    }

    .skin-navy .main-header .navbar .navbar-brand {
      color: white;
    }

    .skin-navy .main-header .navbar .navbar-nav > li > a {
      color: maroon;
    }

    .skin-navy .main-header .navbar .navbar-toggle {
      color: maroon;
    }

    .skin-navy .main-header .navbar .navbar-toggle .icon-bar {
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('dashboard')?>" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>Pesagi</span>
    </a>
